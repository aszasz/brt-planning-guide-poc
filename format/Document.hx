...
/*
	...
	At this stage (after parsing), all the input has been consumed and validated lexically
...
enum HDef {
    ...
    // HRef (label:String, display:Expr<HDef>);
    // HURL (url:String, display:Expr<HDef>);
	// HMath(tex:String);
